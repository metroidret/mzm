...
MAKE_ENUM(u8, BackgroundEffectNum) {
    ...
    BACKGROUND_EFFECT_COUNT
};

MAKE_ENUM(u8, BackgroundEffectCommand) {
    ...
    BACKGROUND_EFFECT_CMD_COUNT
};

#define BACKGROUND_EFFECT_NO_COLOR (COLOR_WHITE + 1) 

MAKE_ENUM(u8, AnimatedPaletteType) {
...
MAKE_ENUM(u8, AnimatedPaletteId) {
    ANIMATED_PALETTE_ID_NONE,
    ANIMATED_PALETTE_ID_ZIPLINE = 3,

    ANIMATED_PALETTE_ID_COUNT = 18
};

MAKE_ENUM(u8, AnimatedGfxType) {
...
MAKE_ENUM(u8, AnimatedGfxId) {
    ...
    ANIMATED_GFX_ID_WEAK_ACID_SURFACE_SLOW,
    ANIMATED_GFX_ID_WEAK_ACID_DEPTH_SLOW,

    ANIMATED_GFX_ID_WEAK_ACID_FALL_LEFT = 30,
