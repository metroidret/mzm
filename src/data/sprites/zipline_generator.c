...
const u32 sZiplineGeneratorGfx[1124] = {
    #include "extracted/data/sprites/zipline_generator.gfx.lz.inc"
};
const u16 sZiplineGeneratorPal[64] = {
    #include "extracted/data/sprites/zipline_generator.pal.inc"
};
