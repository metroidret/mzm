...
const u32 sRisingChozoPillarGfx[671] = {
    #include "extracted/data/sprites/rising_chozo_pillar.gfx.lz.inc"
};
const u16 sRisingChozoPillarPal[64] = {
    #include "extracted/data/sprites/rising_chozo_pillar.pal.inc"
};
