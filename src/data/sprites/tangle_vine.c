...
static const s16 sTangleVineGerutaMultiSpriteData_Idle_Frame0[TANGLE_VINE_GERUTA_PART_COUNT][MULTI_SPRITE_DATA_ELEMENT_COUNT] = {
...
static const s16 sTangleVineGerutaMultiSpriteData_Idle_Frame1[TANGLE_VINE_GERUTA_PART_COUNT][MULTI_SPRITE_DATA_ELEMENT_COUNT] = {
    [TANGLE_VINE_GERUTA_PART_GRIP] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = TANGLE_VINE_OAM_GERUTA_GRIP,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = 0,
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = 0
...
static const s16 sTangleVineGerutaMultiSpriteData_Idle_Frame2[TANGLE_VINE_GERUTA_PART_COUNT][MULTI_SPRITE_DATA_ELEMENT_COUNT] = {
    [TANGLE_VINE_GERUTA_PART_GRIP] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = TANGLE_VINE_OAM_GERUTA_GRIP,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = 0,
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = 0
...
static const s16 sTangleVineGerutaMultiSpriteData_Idle_Frame3[TANGLE_VINE_GERUTA_PART_COUNT][MULTI_SPRITE_DATA_ELEMENT_COUNT] = {
    [TANGLE_VINE_GERUTA_PART_GRIP] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = TANGLE_VINE_OAM_GERUTA_GRIP,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = 0,
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = EIGHTH_BLOCK_SIZE
...
const u32 sTangleVineGfx[1298] = {
    #include "extracted/data/sprites/tangle_vine.gfx.lz.inc"
};
const u16 sTangleVinePal[80] = {
    #include "extracted/data/sprites/tangle_vine.pal.inc"
};
