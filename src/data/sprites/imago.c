...
static const s16 sImagoMultiSpriteData_Idle_Frame0[IMAGO_PART_COUNT][MULTI_SPRITE_DATA_ELEMENT_COUNT] = {
...
static const s16 sImagoMultiSpriteData_Growling_Unused_Frame0[IMAGO_PART_COUNT][MULTI_SPRITE_DATA_ELEMENT_COUNT] = {
    [IMAGO_PART_LEFT_WING_INTERNAL] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = IMAGO_OAM_LEFT_WING_IDLE,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = 0,
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = 0
...
static const s16 sImagoMultiSpriteData_ShootingNeedles_Frame0[IMAGO_PART_COUNT][MULTI_SPRITE_DATA_ELEMENT_COUNT] = {
    [IMAGO_PART_LEFT_WING_INTERNAL] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = IMAGO_OAM_LEFT_WING_IDLE,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = 0,
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = 0
...
static const s16 sImagoMultiSpriteData_ShootingNeedles_Frame1[IMAGO_PART_COUNT][MULTI_SPRITE_DATA_ELEMENT_COUNT] = {
    [IMAGO_PART_LEFT_WING_INTERNAL] = {
...
static const s16 sImagoMultiSpriteData_RechargingNeedles_Frame0[IMAGO_PART_COUNT][MULTI_SPRITE_DATA_ELEMENT_COUNT] = {
    [IMAGO_PART_LEFT_WING_INTERNAL] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = IMAGO_OAM_LEFT_WING_IDLE,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = 0,
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = 0
...
static const s16 sImagoMultiSpriteData_Dying_Frame0[IMAGO_PART_COUNT][MULTI_SPRITE_DATA_ELEMENT_COUNT] = {
    [IMAGO_PART_LEFT_WING_INTERNAL] = {
...
const u32 sImagoGfx[1503] = {
    #include "extracted/data/sprites/imago.gfx.lz.inc"
};
const u16 sImagoPal[96] = {
    #include "extracted/data/sprites/imago.pal.inc"
};
