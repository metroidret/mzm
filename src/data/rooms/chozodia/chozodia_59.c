...
const u8 sChozodia_59_Clipdata[374] = {
    #include "extracted/data/rooms/chozodia/chozodia_59_clipdata.gfx.inc"
};
...
const u8 sChozodia_59_Bg1[793] = {
    #include "extracted/data/rooms/chozodia/chozodia_59_bg1.gfx.inc"
};
