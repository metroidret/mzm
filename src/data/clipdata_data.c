...
const u16 sHazardsDefinitions[EFFECT_HAZARD_COUNT][2] = {
    [EFFECT_NONE] = { HAZARD_TYPE_NONE, HAZARD_TYPE_NONE },
    [EFFECT_WATER] = { HAZARD_TYPE_NONE, HAZARD_TYPE_WATER },
    [EFFECT_LAVA] = { HAZARD_TYPE_NONE, HAZARD_TYPE_LAVA },
    [EFFECT_WEAK_ACID] = { HAZARD_TYPE_NONE, HAZARD_TYPE_WEAK_ACID },
    [EFFECT_LAVA_HEAT_HAZE] = { HAZARD_TYPE_HEAT, HAZARD_TYPE_LAVA },
    [EFFECT_STRONG_ACID] = { HAZARD_TYPE_NONE, HAZARD_TYPE_STRONG_ACID },
...
const u16 sHazardClipdataValues[4] = {
    ...
    [BEHAVIOR_TO_HAZARD(CLIP_BEHAVIOR_LAVA)] = HAZARD_TYPE_LAVA,
    [BEHAVIOR_TO_HAZARD(CLIP_BEHAVIOR_WEAK_ACID)] = HAZARD_TYPE_WEAK_ACID,
    [BEHAVIOR_TO_HAZARD(CLIP_BEHAVIOR_STRONG_ACID)] = HAZARD_TYPE_STRONG_ACID
};

const GroundEffect sGroundEffectsClipdataValues[8] = {
...
const struct CameraScrollVelocityCaps sScrollVelocityCaps[SCROLL_VELOCITY_CAP_COUNT] = {
